...
export default function EmployeeLogin() {
  ...
  return <main className="grid min-h-[100dvh] place-items-center bg-[#0B1328] px-3 py-6 sm:px-4 sm:py-10 [padding-top:max(1.5rem,env(safe-area-inset-top))] [padding-bottom:max(1.5rem,env(safe-area-inset-bottom))]">
