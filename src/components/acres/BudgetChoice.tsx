      ...
      <div className="max-w-[1200px] mx-auto px-5">
        <div className="grid md:grid-cols-[280px_1fr] gap-6 items-center">
          <div>
            ...
            <h2 className="text-[24px] md:text-[28px] font-bold text-[#121B35]">Have a budget in mind?</h2>
            <p className="text-[13px] text-[#68646F] mt-1">Project options based on your budget</p>
          </div>
          <div className="bg-white rounded-2xl border border-[#E4E0E7]/60 shadow-sm p-6">
            <p className="text-[16px] font-bold text-[#121B35]">Browse by budget</p>
            <p className="text-[13px] text-[#68646F]">Project options based on your budget</p>
            <div className="mt-4 divide-y divide-[#E4E0E7]/50">
              {budgetOptions.map((b) => (
                <Link key={b.label} href={b.href} className="group flex items-center justify-between py-4 hover:bg-[#FDFCFD] -mx-2 px-2 rounded-lg transition-colors">
                  <span className="flex items-center gap-3">
                    <span className="size-10 rounded-full bg-[#E6F2EA] flex items-center justify-center text-[#1E7A46]">
                      <IndianRupee className="size-5" />
                    </span>
                    <span>
                      <span className="block text-[15px] font-bold text-[#121B35]">{b.label}</span>
                      <span className="block text-[12px] text-[#68646F]">{b.range}</span>
                    </span>
                  </span>
