...
export default function FamilyWorkspaceDock() {
  ...
  return <aside className="public-family-dock fixed bottom-4 right-4 z-50 flex flex-col items-end gap-2 lg:bottom-5 lg:right-5" aria-label="Family home decision workspace">
