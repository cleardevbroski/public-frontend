      ...
      <div className="max-w-[1200px] mx-auto px-5">
        ...
        <div className="text-center mt-10">
          <Link
            ...
            className="inline-flex items-center gap-2 text-[14px] font-bold text-[#1E3A8A] border border-[#1E3A8A]/20 hover:border-[#D4AF37] hover:text-[#D4AF37] px-6 py-3 rounded-xl transition-all"
          >
            Browse All Listings
