...
export default function FeaturedDealers() {
  ...
  return (
    <section className="bg-[#FAF3E2] py-14">
      <div className="max-w-[1200px] mx-auto px-5">
        <div className="flex items-end justify-between mb-6 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <span className="size-12 rounded-full bg-gradient-to-br from-[#E8C66A] to-[#D4AF37] flex items-center justify-center text-[#1E3A8A] shadow">
            ...
            <div>
              ...
              <p className="text-[13px] text-[#6E7488]">who are popular amongst Residential Buyers</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/dealers" className="text-[14px] font-bold text-[#D4AF37] hover:underline">View all</Link>
