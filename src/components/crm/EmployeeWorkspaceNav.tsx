...
export default function EmployeeWorkspaceNav({ active }: { active: Workspace }) {
  ...
  return <><div className="hidden h-20 md:block" aria-hidden="true" /><nav aria-label="Employee workspaces" className="fixed inset-x-0 bottom-0 z-50 border-t border-[#D8DCE2] bg-white/95 px-2 pt-2 shadow-[0_-8px_24px_rgba(11,19,40,0.12)] backdrop-blur md:inset-x-auto md:bottom-5 md:left-1/2 md:-translate-x-1/2 md:rounded-lg md:border md:p-1.5 [padding-bottom:max(0.5rem,env(safe-area-inset-bottom))]">
