  ...
  return (
    <section className="rounded-2xl border border-[#DDAA42]/45 bg-[#FFFBF1] p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2"><button type="button" onClick={downloadPropertyDescriptionFormat} className="rounded-xl border border-[#DDAA42] bg-white px-3 py-2.5 text-[12px] font-bold text-[#805C12]">Description format</button><button type="button" onClick={downloadPropertyExcelTemplate} className="rounded-xl border border-[#DDAA42] bg-white px-3 py-2.5 text-[12px] font-bold text-[#805C12]">Excel template</button><button type="button" onClick={() => fileInput.current?.click()} disabled={loading} className="inline-flex items-center gap-2 rounded-xl bg-[#121B35] px-4 py-2.5 text-[12px] font-bold text-white disabled:opacity-60">
      ...
      {suggestion && (
        <div className="mt-4 rounded-xl border border-[#D8DDE4] bg-white p-4">
          ...
          <div className="mt-3 max-h-40 overflow-y-auto rounded-lg border border-[#EEF0F3] text-[12px]">
